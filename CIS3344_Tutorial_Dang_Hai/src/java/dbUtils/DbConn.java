    ...
    private void connect(boolean isTemple) {
        ...
        try {
            ...
            try {              
                ...
                String url = "jdbc:mysql://localhost:3307/sp17_3344_1_tug25055?user=tug25055&password=fialonam";
                
                // unless you are working from temple (wachman hall)
                if (isTemple) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/sp17_3344_1_tug25055?user=tug25055&password=fialonam";  
                }                 
