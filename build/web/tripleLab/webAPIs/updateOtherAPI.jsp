...
<%
    ...
    if(session.getAttribute("user") == null){
        errorMsgs.errorMsg = "Unauthorized - Please login to update.";
        System.out.println("Unauthorized - Please login to update.");
    }
    ...
    if (jsonUpdateData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            ...
            System.out.println("planetUpdate.jsp ready to update from this data: "
                    + jsonUpdateData);
            ...
            errorMsgs = DbPlanetMods.update(updateData, dbc); // this is the form level message 
            
            System.out.println("planetUpdate.jsp found these errors: "
                    + jsonUpdateData);
        }
    }
