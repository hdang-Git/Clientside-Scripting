...
demoApp.controller('personUpdateController', function ($scope, $http, $routeParams, SkService) {
    ...
    $scope.updateSave = function () {
        ...
        var url = "webAPIs/personUpdate.jsp?jsonData=" + myData;
