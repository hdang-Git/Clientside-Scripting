...
<%@page import="model.Scientist.DbScientistMods"%>
<%@page import="model.Scientist.StringData"%>
...
<%
    ...
    //get json data from url parameter and insert into table
    ...
    if (jsonInsertData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            ...
            errorMsgs = DbScientistMods.insert(insertData, dbc); // this is the form level message
        }
    }
