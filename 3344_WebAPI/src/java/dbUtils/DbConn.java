    ...
    private void connect(boolean isTemple) {
        ...
        try {
            ...
            try {              
                ...
                String url = "jdbc:mysql://localhost:3307/SP16_3344_sallyk?user=sallyk&password=Vaca1415";
                
                // unless you are working from temple (wachman hall)
                if (isTemple) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/SP16_3344_sallyk?user=sallyk&password=Vaca1415";  
                }                 
